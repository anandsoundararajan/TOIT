...
enyo.kind({
  name: 'OB.OBPOSPointOfSale.UI.SplitBillTwo',
  kind: 'OB.UI.WindowView',
  windowmodel: OB.OBPOSPointOfSale.Model.SplitBillModelTwo,
  tag: 'section',
...
OB.POS.registerWindow({
  windowClass: OB.OBPOSPointOfSale.UI.SplitBillTwo,
  route: 'rt.splitbilltwo',
  menuPosition: 17,
  permission: 'OBPOS_retail.pointofsale',
  menuLabel: 'RTSPLBLTWO',
  menuI18NLabel: 'RTSPLBLTWO',
});