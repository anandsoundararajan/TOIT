...
String strParamName = vars.getSessionValue(tabId + "|paramName");
    ...
    hasSearchCondition = (tableSQL.hasInternalFilter() && ("").equals(strParamC_Currency_ID) && ("").equals(strParamName)) || !(("").equals(strParamC_Currency_ID) || ("%").equals(strParamC_Currency_ID))  || !(("").equals(strParamName) || ("%").equals(strParamName)) ;
