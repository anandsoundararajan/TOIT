...
xmlDocument.setParameter("Create_Reg_Fact_Acct_BTNname", Utility.getButtonName(this, vars, "800732", "Create_Reg_Fact_Acct_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalCreate_Reg_Fact_Acct = org.openbravo.erpCommon.utility.Utility.isModalProcess("800036"); 
xmlDocument.setParameter("Create_Reg_Fact_Acct_Modal", modalCreate_Reg_Fact_Acct?"true":"false");
xmlDocument.setParameter("Drop_Reg_Fact_Acct_BTNname", Utility.getButtonName(this, vars, "800733", "Drop_Reg_Fact_Acct_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalDrop_Reg_Fact_Acct = org.openbravo.erpCommon.utility.Utility.isModalProcess("800038"); 
xmlDocument.setParameter("Drop_Reg_Fact_Acct_Modal", modalDrop_Reg_Fact_Acct?"true":"false");
