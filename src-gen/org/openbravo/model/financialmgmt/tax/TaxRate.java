...
public class TaxRate extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_INTXINDIANTAXCATEGORY = "intxIndianTaxcategory";
    ...
    public String getIntxIndianTaxcategory() {
        return (String) get(PROPERTY_INTXINDIANTAXCATEGORY);
    }

    public void setIntxIndianTaxcategory(String intxIndianTaxcategory) {
        set(PROPERTY_INTXINDIANTAXCATEGORY, intxIndianTaxcategory);
    }
