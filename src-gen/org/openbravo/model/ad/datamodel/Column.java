...
public class Column extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OBINUTLMASK = "oBINUTLMask";
    ...
    public String getOBINUTLMask() {
        return (String) get(PROPERTY_OBINUTLMASK);
    }

    public void setOBINUTLMask(String oBINUTLMask) {
        set(PROPERTY_OBINUTLMASK, oBINUTLMask);
    }
